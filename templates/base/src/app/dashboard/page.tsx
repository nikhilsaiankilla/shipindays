            ...
            <div className="flex-1 flex flex-col items-center justify-center p-6 text-center relative">
                ...
                <div className="max-w-2xl w-full relative z-10">
                    ...
                    <div className="inline-block bg-white border-2 border-black px-4 py-1 mb-6 rotate-[-1deg] shadow-[3px_3px_0px_#000]">
                        <p className="text-[10px] font-black uppercase tracking-[0.3em]">Developer_Workspace // v1.0.4</p>
                    </div>

                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter uppercase italic leading-[0.85] mb-8">
                        Design your <br /> 
                        <span className="text-orange-500 underline decoration-black/10">Dashboard</span> here.
                    </h1>

                    <p className="text-lg font-bold text-zinc-500 italic mb-12 max-w-lg mx-auto leading-tight">
                        "The authentication kernel is live. Now, verify your payment flow and show some love to the engine."
                    </p>
                    ...
                    <div className="grid sm:grid-cols-2 gap-6 mb-12">
                        ...
                        <div className="bg-white border-4 border-black p-6 rounded-[15px_40px_10px_35px] shadow-[8px_8px_0px_#3B82F6] hover:-translate-y-1 transition-all text-left group">
                            ...
                            <h3 className="font-black uppercase italic text-sm mb-2">01. Test Payments</h3>
                            <p className="text-[11px] font-bold text-zinc-400 mb-6 leading-tight">Check if Stripe/Dodo webhooks are firing correctly.</p>
                            <Link href="/pricing" className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest bg-black text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors">
                        ...
                        <div className="bg-white border-4 border-black p-6 rounded-[40px_15px_35px_10px] shadow-[8px_8px_0px_#FFA500] hover:-translate-y-1 transition-all text-left group">
                            ...
                            <h3 className="font-black uppercase italic text-sm mb-2">02. Support Engine</h3>
                            <p className="text-[11px] font-bold text-zinc-400 mb-6 leading-tight">If everything is working, help us grow the kernel.</p>
                            <Link href="https://github.com/nikhilsaiankilla/shipindays" target="_blank" className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest bg-black text-white px-4 py-2 rounded-lg hover:bg-orange-600 transition-colors">
